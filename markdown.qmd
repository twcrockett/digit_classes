...
I'm tackling the provided Kaggle digit data which is a tensor of size (9298, 16, 16). As I write this today, I am using a 2-year old Dell laptop with
...
lr_results <- read_csv(show_col_types = FALSE, "data/lr_results.csv")
...
svd_results <- read_csv(show_col_types = FALSE, "data/svd_results.csv")
...
hosvd_results <- read_csv(show_col_types = FALSE, "data/hosvd_results.csv")
...
lda_results <- read_csv(show_col_types = FALSE, "data/lda_results.csv")
...
knn_results <- read_csv(show_col_types = FALSE, "data/knn_results.csv")
...
rf_results <- read_csv(show_col_types = FALSE, "data/rf_results.csv")

results_table(
  rf_results,
  prefix_cols=list(
    n_estimators = colDef(name = "Trees", minWidth = 80),
    max_depth = colDef(name = "Max. depth", minWidth = 110),
    min_samples_split = colDef(name = "Min. split", minWidth = 90)
  )
)
...
nb_results <- read_csv(show_col_types = FALSE, "data/nb_results.csv")
...
svm_results <- read_csv(show_col_types = FALSE, "data/svm_results.csv")
...
greedy_results <- read_csv(show_col_types = FALSE, "data/greedy_results.csv")
