...
```
```{python final_analysis}
#| echo: false
#| warning: false

top_models = greedy_df.head(3)['model'].tolist()
base_model_names = [name.split('(')[0].strip() for name in top_models]
confusion_matrices = generate_confusion_matrices(
    base_model_names,
    model_functions,
    X_gtrain, X_gtest, y_gtrain, y_gtest
)

# Visualize model performance
visualize_model_performance(
    greedy_df,
    save_path="model_performance_visualization.png",  # Optional: save the plot
